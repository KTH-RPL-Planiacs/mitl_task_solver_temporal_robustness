...
if __name__ == '__main__':
    ...
    e1 = MTLFormula.Eventually(MTLFormula.Predicate('s_9_2'),12,24)
    e2 = MTLFormula.Always(MTLFormula.Predicate('s_3_4'),30,35)
    e3 = MTLFormula.Eventually(MTLFormula.Predicate('s_8_2'),20,28)
    a2 = MTLFormula.Always(MTLFormula.Predicate('s_1_3'),1,5)
    a1 = MTLFormula.Eventually(MTLFormula.Predicate('s_8_1'),40,47)

 
    Demands = [(e1,1),(e2,1),(e3,1),(a2,1), (a1,1)][:D]
