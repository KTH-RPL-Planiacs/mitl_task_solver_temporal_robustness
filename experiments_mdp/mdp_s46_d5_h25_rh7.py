...
if __name__ == '__main__':
    ...
    e2 = MTLFormula.Always(MTLFormula.Predicate('s_3_4'),15,18)
    e3 = MTLFormula.Eventually(MTLFormula.Predicate('s_8_2'),10,14)
    a2 = MTLFormula.Always(MTLFormula.Predicate('s_1_3'),1,3)
    a1 = MTLFormula.Eventually(MTLFormula.Predicate('s_8_1'),16,23)
