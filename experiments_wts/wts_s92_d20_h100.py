...
if __name__ == '__main__':
    ...
    e3 = MTLFormula.Eventually(MTLFormula.Predicate('M2'),40,45)
    e4 = MTLFormula.Eventually(MTLFormula.Predicate('F1_O1'),47,49)
    
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),50,52)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),64,66)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('O2'),78,82)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('F1_M1'),80,85)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('F1_E2'),85,89)
    
    n1 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('O3'),30,45))
    n2 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('K'),15,45))
    n3 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('M1'),10,28))
    n4 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('F1_O4'),1,25))
    c1 = MTLFormula.Conjunction([MTLFormula.Always(MTLFormula.Predicate('O5'),50,55),MTLFormula.Always(MTLFormula.Predicate('O2'),66,70)]) 
    c2 = MTLFormula.Conjunction([MTLFormula.Eventually(MTLFormula.Predicate('O6'),10,40),MTLFormula.Always(MTLFormula.Predicate('F1_O4'),40,50)]) 
    d1 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('F1_K'),10,40),MTLFormula.Eventually(MTLFormula.Predicate('O5'),60,70)]) 
    d2 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('M2'),1,49),MTLFormula.Eventually(MTLFormula.Predicate('F1_E1'),1,49)]) 
    ae = MTLFormula.Always(MTLFormula.Eventually(MTLFormula.Predicate('F1_O1'),5,10),15,20)
    ea = MTLFormula.Eventually(MTLFormula.Always(MTLFormula.Predicate('O7'),5,10),55,60)
