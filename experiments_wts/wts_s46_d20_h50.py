...
if __name__ == '__main__':
    ...
    e4 = MTLFormula.Eventually(MTLFormula.Predicate('Jana'),47,49)
    
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),20,22)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),14,16)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('Alexis'),28,32)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('M1'),30,45)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('E2'),45,49)
    
    n1 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('Base'),30,45))
    ...
    n4 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('O2'),1,25))
    c1 = MTLFormula.Conjunction([MTLFormula.Always(MTLFormula.Predicate('O1'),20,25),MTLFormula.Always(MTLFormula.Predicate('O2'),26,30)]) 
    c2 = MTLFormula.Conjunction([MTLFormula.Eventually(MTLFormula.Predicate('O3'),10,40),MTLFormula.Always(MTLFormula.Predicate('O4'),40,42)]) 
    d1 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('K'),10,40),MTLFormula.Eventually(MTLFormula.Predicate('O5'),40,49)]) 
    ...
    ae = MTLFormula.Always(MTLFormula.Eventually(MTLFormula.Predicate('O1'),5,10),15,20)
    ea = MTLFormula.Eventually(MTLFormula.Always(MTLFormula.Predicate('O3'),5,10),15,20)
