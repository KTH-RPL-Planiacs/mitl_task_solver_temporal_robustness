...
if __name__ == '__main__':
    ...
    e4 = MTLFormula.Eventually(MTLFormula.Predicate('Jana'),80,90)
    
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),65,68)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),30,35)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('Alexis'),25,32)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('M1'),50,60)
    ...
    c1 = MTLFormula.Conjunction([MTLFormula.Always(MTLFormula.Predicate('O1'),20,25),MTLFormula.Always(MTLFormula.Predicate('O2'),26,28)]) 
    c2 = MTLFormula.Conjunction([MTLFormula.Eventually(MTLFormula.Predicate('O3'),10,40),MTLFormula.Always(MTLFormula.Predicate('O4'),75,80)]) 
    d1 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('K'),10,40),MTLFormula.Eventually(MTLFormula.Predicate('O5'),40,80)]) 
    ...
    ea = MTLFormula.Eventually(MTLFormula.Always(MTLFormula.Predicate('O3'),5,10),50,60)
