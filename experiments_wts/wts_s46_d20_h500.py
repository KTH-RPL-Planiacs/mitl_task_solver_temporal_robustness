...
if __name__ == '__main__':
    ...
    a1 = MTLFormula.Always(MTLFormula.Predicate('E2'),200,250)
    e3 = MTLFormula.Eventually(MTLFormula.Predicate('M2'),230,270)
    e4 = MTLFormula.Eventually(MTLFormula.Predicate('Jana'),450,470)
    ...
    n3 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('M1'),300,400))
    n4 = MTLFormula.Negation(MTLFormula.Always(MTLFormula.Predicate('O2'),100,400))
    c1 = MTLFormula.Conjunction([MTLFormula.Always(MTLFormula.Predicate('O1'),210,225),MTLFormula.Always(MTLFormula.Predicate('O2'),70,80)]) 
    c2 = MTLFormula.Conjunction([MTLFormula.Eventually(MTLFormula.Predicate('O3'),310,340),MTLFormula.Always(MTLFormula.Predicate('O4'),240,242)]) 
    d1 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('K'),110,140),MTLFormula.Eventually(MTLFormula.Predicate('O5'),440,449)]) 
    d2 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('M2'),1,49),MTLFormula.Eventually(MTLFormula.Predicate('E1'),1,99)]) 
    ae = MTLFormula.Always(MTLFormula.Eventually(MTLFormula.Predicate('O1'),5,10),300,350)
    ea = MTLFormula.Eventually(MTLFormula.Always(MTLFormula.Predicate('O3'),5,10),120,150)
