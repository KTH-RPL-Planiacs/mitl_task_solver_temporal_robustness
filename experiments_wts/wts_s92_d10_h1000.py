...
if __name__ == '__main__':
    ...
    e3 = MTLFormula.Eventually(MTLFormula.Predicate('M2'),430,445)
    e4 = MTLFormula.Eventually(MTLFormula.Predicate('O4'),470,490)
    
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),500,502)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),640,660)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('F1_O1'),708,732)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('F1_M1'),830,845)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('E2'),945,959)
