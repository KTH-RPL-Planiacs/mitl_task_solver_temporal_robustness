...
if __name__ == '__main__':
    ...
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),20,22)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),14,16)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('O2'),28,32)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('F1_M1'),30,45)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('F1_E2'),45,49)
    ...
    c1 = MTLFormula.Conjunction([MTLFormula.Always(MTLFormula.Predicate('O5'),20,25),MTLFormula.Always(MTLFormula.Predicate('O2'),26,30)]) 
    c2 = MTLFormula.Conjunction([MTLFormula.Eventually(MTLFormula.Predicate('O6'),10,40),MTLFormula.Always(MTLFormula.Predicate('F1_O4'),40,42)]) 
    d1 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('F1_K'),10,40),MTLFormula.Eventually(MTLFormula.Predicate('O5'),40,49)]) 
    ...
    ea = MTLFormula.Eventually(MTLFormula.Always(MTLFormula.Predicate('O7'),5,10),15,20)
