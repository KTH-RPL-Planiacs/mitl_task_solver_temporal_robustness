...
if __name__ == '__main__':
    ...
    e2 = MTLFormula.Eventually(MTLFormula.Predicate('M2'),30,36)
    a1 = MTLFormula.Always(MTLFormula.Predicate('E2'),60,70)
    e3 = MTLFormula.Eventually(MTLFormula.Predicate('M2'),80,90)
    e4 = MTLFormula.Eventually(MTLFormula.Predicate('O4'),90,95)
    
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),40,44)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),28,32)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('F1_O1'),60,64)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('F1_M1'),60,75)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('E2'),80,95)
