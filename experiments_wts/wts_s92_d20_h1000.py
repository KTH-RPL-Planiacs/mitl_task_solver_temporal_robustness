...
if __name__ == '__main__':
    ...
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),500,520)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),640,646)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('O2'),780,820)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('F1_M1'),800,805)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('F1_E2'),855,859)
    ...
    c1 = MTLFormula.Conjunction([MTLFormula.Always(MTLFormula.Predicate('O5'),510,515),MTLFormula.Always(MTLFormula.Predicate('O2'),676,680)]) 
    c2 = MTLFormula.Conjunction([MTLFormula.Eventually(MTLFormula.Predicate('O6'),710,740),MTLFormula.Always(MTLFormula.Predicate('F1_O4'),740,750)]) 
    d1 = MTLFormula.Disjunction([MTLFormula.Eventually(MTLFormula.Predicate('F1_K'),810,840),MTLFormula.Eventually(MTLFormula.Predicate('O5'),860,870)]) 
    ...
    ea = MTLFormula.Eventually(MTLFormula.Always(MTLFormula.Predicate('O7'),5,10),940,960)
