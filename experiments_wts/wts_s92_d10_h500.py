...
if __name__ == '__main__':
    ...
    a2 = MTLFormula.Always(MTLFormula.Predicate('P'),200,202)
    a3 = MTLFormula.Always(MTLFormula.Predicate('E1'),140,160)
    e5 = MTLFormula.Eventually(MTLFormula.Predicate('F1_O1'),208,232)
    e6 = MTLFormula.Eventually(MTLFormula.Predicate('F1_M1'),430,445)
    e7 = MTLFormula.Eventually(MTLFormula.Predicate('E2'),445,459)
